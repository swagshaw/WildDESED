...
if __name__ == "__main__":
    ...
    if use_gpu:
        pretrained = pretrained.to('cuda:1')
    ...
    # devtest_dataset = WavDataset(
    #     config["data"]["noise_train_folder"]+'train0db/', feats_pipeline=feature_extraction
    # )
    
    for k, elem in {
        # "synth_train_random_noise": synth_set,
        # "weak_train": weak_set,
        ...
        # ------------------ devtest_10db, synth_train_{noise_level}.hdf5
        "test_-5db_sep_sed_RN": devtest_dataset,
